#!/bin/bash
# =============================================================================
# setup_looker_gemini_enterprise.sh (v6.5 - Anti-silencio + thinking budget)
# Mejoras v6.5 sobre v6.4:
#   - RESPONSE RULE #1: prohibe explicitamente respuestas vacias
#   - FIRST QUESTION rule: ejecuta sin titubear en el primer turno
#   - thinking_budget=2048 (en lugar de 0) para que el LLM tenga espacio
#     mental para procesar discovery + filter + query sin abandonarse
#   - Filtros por servicio especifico con discovery previo de service names
#
# Razon del cambio: en v6.4 el agente a veces NO responde en la primera vuelta
# pero SI responde al segundo turno. v6.5 obliga a que SIEMPRE responda.
# =============================================================================
...
root_agent = LlmAgent(
    ...
    planner=BuiltInPlanner(
        thinking_config=ThinkingConfig(include_thoughts=False, thinking_budget=2048)
    ),
    tools=[
        MCPToolset(
