#!/bin/bash
# =============================================================================
# setup_looker_gemini_enterprise.sh (v4 - FINAL privado)
# Arquitectura:
...
#   4. Dashboards renderizados como PNG al bucket PRIVADO
#   5. Signed URLs via IAM signBlob API directo (sin impersonation circular)
#   6. PNGs auto-borrados despues de 1 dia
# =============================================================================
