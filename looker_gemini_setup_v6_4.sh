#!/bin/bash
# =============================================================================
# setup_looker_gemini_enterprise.sh (v6.4 - Aggressive prompt anti-question)
# Mejoras v6.4 sobre v6.3:
#   - Prompt MUCHO mas estricto contra preguntar al usuario por metadata
#   - Reglas absolutas (NEVER ask) en lugar de sugerencias (try to discover)
#   - Secuencia de ejecucion obligatoria numerada (Step 1 -> 5)
#   - Manejo de errores explicito - le dice al LLM que NUNCA pida ayuda
#     al usuario, siempre intentar alternativas el mismo
#   - Memoria de conversacion explicita para reusar discovery
#
# Uso: corre este si v6.3 te pide modelo/explore en lugar de descubrirlos.
# Resto: identico al v6.3 (Cloud Run, MCP Toolbox, agent SA, etc)
# =============================================================================
